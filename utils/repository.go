...
func NewRepositoryBuilder(db *gorm.DB, model contract.Model) *RepositoryBuilder {
...
func (rb *RepositoryBuilder) BuildRepository(db *gorm.DB, model contract.Model) interface{} {
...
func CreateRepositoryInstance(db *gorm.DB, model contract.Model) interface{} {
	return struct {
		DB    *gorm.DB
