...
func TestModelTemplate(t *testing.T) {
	...
	require.Contains(t, modelTemplate, "github.com/hbttundar/scg-database/contract")
	require.NotContains(t, modelTemplate, "github.com/hbttundar/scg-database/adapter/gorm")
}
